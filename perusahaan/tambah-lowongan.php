...
<div class="modal fade" id="verifikasiModal" tabindex="-1" aria-labelledby="verifikasiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title" id="verifikasiModalLabel">Iklan Diverifikasi</h5>
            </div>
            <div class="modal-body">Iklan sedang diverifikasi. Silakan tunggu persetujuan dari admin.</div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="modalCloseBtn">Oke</button>
            </div>
        </div>
    </div>
</div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    <script>
        const formLowongan = document.getElementById('formLowongan');
        ...
        modalCloseBtn.addEventListener('click', function() {
            ...
            formLowongan.submit(); // Submit form setelah modal ditutup
        });
    </script>
</body>
</html>
