...
<body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <div class="d-flex align-items-center mx-1">
                    ...
                    <a href="logout-perusahaan.php" class="btn btn-outline-danger ms-2" style="font-size: 0.9rem;" onclick="return confirm('Yakin ingin logout?');">
                        Logout
                    </a>
                </div>
            </div>
    ...
    <div class="text-center mt-4 bg-light">
        <a href="../pelamar/cari-loker.php" class="btn border-0 border-bottom border-secondary text-dark fw-medium bg-transparent">
            Lihat Lebih Banyak
        </a>
    </div>
